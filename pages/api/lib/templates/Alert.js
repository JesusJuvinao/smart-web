module.exports = ({ username, code, company }) => {
    return `<!DOCTYPE html>
  ...
  <tr>
  <td>
  <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #d9dffa; background-image: url('images/body_background_2.png'); background-position: top center; background-repeat: repeat;" width="100%">
  <tbody>
  <tr>
  <td>
  ...
  <p style="margin: 0; font-size: 14px;">You have received an invitation to join the company ${ company }<br/>access the following link to continue</p>
  </div>
  </div>
  </td>
  </tr>
